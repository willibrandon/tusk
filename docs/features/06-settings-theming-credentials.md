  ...
  <svelte:fragment slot="footer">
    <div class="flex items-center justify-between w-full">
      ...
      <div class="flex gap-2">
        <button
          class="px-4 py-1.5 text-sm border rounded hover:bg-gray-50"
...
<div class="space-y-6">
  ...
  <FormField label="Startup">
    <Select
      ...
      bind:value={settings.general.startup}
      onchange={onchange}
    />
  </FormField>
...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-2 gap-4">
    <FormField label="Font Family">
      <Select
        ...
        bind:value={settings.editor.fontFamily}
        onchange={onchange}
      />
    </FormField>
  ...
  <div class="space-y-3">
    ...
    <Checkbox
      bind:checked={settings.editor.bracketMatching}
      onchange={onchange}
...
<div class="space-y-6">
  ...
  <FormField label="Default row limit">
    ...
    <p class="text-xs text-gray-500 mt-1">
      Maximum rows to fetch for SELECT queries without LIMIT
    </p>
  </FormField>
  ...
  <FormField label="Date/Time format">
    <Select
      options={dateFormats}
      bind:value={settings.results.dateFormat}
      onchange={onchange}
    />
  </FormField>
  ...
  <FormField label="NULL display">
    <Input
      type="text"
      bind:value={settings.results.nullDisplay}
      onchange={onchange}
      placeholder="NULL"
    />
  </FormField>
  ...
  <FormField label="Copy format">
    <Select
      options={copyFormats}
      bind:value={settings.results.copyFormat}
      onchange={onchange}
    />
  </FormField>
</div>
