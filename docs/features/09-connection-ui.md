            ...
            <FormField label="CA Certificate" required>
              <div class="flex gap-2">
                <Input
                  ...
                  class="flex-1"
                />
                <Button variant="secondary" onclick={handleBrowseCaCert}>
                  Browse
                </Button>
              </div>
            </FormField>
          ...
          <FormField label="Client Certificate">
            <div class="flex gap-2">
              <Input
                ...
                class="flex-1"
              />
              <Button variant="secondary" onclick={handleBrowseClientCert}>
                Browse
              </Button>
            </div>
          </FormField>
          ...
          <FormField label="Client Key">
            <div class="flex gap-2">
              <Input
                ...
                class="flex-1"
              />
              <Button variant="secondary" onclick={handleBrowseClientKey}>
                Browse
              </Button>
            </div>
          </FormField>
              ...
              <FormField label="SSH Key File">
                <div class="flex gap-2">
                  <Input
                    ...
                    class="flex-1"
                  />
                  <Button variant="secondary" onclick={handleBrowseSshKey}>
                    Browse
                  </Button>
                </div>
              </FormField>
      ...
      {:else if activeTab === 'options'}
        <div class="space-y-4">
          <FormField label="Connection Timeout (seconds)">
            <Input
              type="number"
              bind:value={config.options.connectTimeoutSec}
              min="1"
              max="300"
            />
          </FormField>
          ...
          <FormField label="Application Name">
            <Input
              type="text"
              bind:value={config.options.applicationName}
              placeholder="Tusk"
            />
          </FormField>

          <Checkbox
            bind:checked={config.options.readonly}
...
>
  ...
  {#if connection.config.color}
    <span
      ...
      style="background-color: {connection.config.color}"
    ></span>
  {/if}
